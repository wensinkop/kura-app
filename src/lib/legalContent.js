...
const PRIVACY_MD = `Kura is a personal-finance app that helps you track your income, expenses and transfers across your accounts. We take your privacy seriously — Kura is built so that your financial data stays yours. This policy explains what we collect, how we use it, who processes it, and the rights you have over it.

Kura is operated by **Stanley Leeansyah** as an individual (“we”, “us”, “Kura”), who is the data controller responsible for your personal data. You can reach us any time at [${CONTACT}](mailto:${CONTACT}).

## Who this applies to
This policy applies to everyone who uses Kura. Our users are primarily based in Indonesia, so we handle personal data in line with Indonesia’s Personal Data Protection Law (Undang-Undang No. 27 Tahun 2022 tentang Pelindungan Data Pribadi, “UU PDP”). Kura is not intended for children under the age of 17.

## What we collect
We only collect what Kura needs to work for you:
...
We do **not** sell your personal data, and we do **not** use it for advertising. We do not show ads in Kura today; if that ever changes, we will update this policy and tell you before it takes effect.
...
We may update this policy as Kura evolves. When we do, we’ll change the “Last updated” date above, and for significant changes we’ll give you notice in the app.

## Contact
Questions about your privacy or this policy? Email [${CONTACT}](mailto:${CONTACT}).`

const TERMS_MD = `These Terms & Conditions (“Terms”) govern your use of Kura, a personal-finance app operated by **Stanley Leeansyah** (“we”, “us”, “Kura”). By creating an account or using Kura, you agree to these Terms. If you do not agree, please don’t use the app.

## 1. What Kura is
Kura is a tool that helps you record and review your own income, expenses, transfers and account balances across multiple accounts and currencies. It is an organisational and informational tool only.

## 2. Not financial advice
Kura does **not** provide financial, investment, tax, accounting or legal advice. Anything Kura shows you — balances, totals, statistics, net worth, converted amounts — is for your own information based on the data you entered. You are solely responsible for your financial decisions. Always consult a qualified professional before making important financial choices.

## 3. Your account
- You must be at least 17 years old to use Kura.
...
## 4. Acceptable use
You agree not to misuse Kura — including attempting to access other users’ data, disrupting the service, reverse-engineering it, or using it for any unlawful purpose.

## 5. The data you enter
The financial data in Kura is yours. You are responsible for its accuracy and for keeping your own backups. Kura provides export and backup tools (Settings → Backup & data) — we strongly encourage you to use them regularly. We are not responsible for data you delete or for inaccuracies in the data you enter.
...
Some features (currently the bank-statement converter) are part of Kura Premium. Premium is **invite-only at this time and is granted manually at no charge** while Kura is in its early stage. If and when we introduce paid subscriptions, the price, billing cycle, renewal, cancellation and refund terms will be shown to you clearly at the point of purchase (for example, through the Google Play Store), and those terms — together with the platform’s own rules — will apply to that purchase. We may change which features are free or premium over time.

## 8. Availability
We work to keep Kura available and reliable, but we provide it on an “as is” and “as available” basis. We may change, suspend or discontinue features, and we don’t guarantee the service will be uninterrupted or error-free.

## 9. Disclaimer of warranties
To the fullest extent permitted by law, Kura is provided **“as is”** without warranties of any kind, whether express or implied, including fitness for a particular purpose and accuracy of results.

## 10. Limitation of liability
To the fullest extent permitted by Indonesian law, we will not be liable for any indirect, incidental, or consequential damages, or for any loss of data, profits or financial loss arising from your use of — or inability to use — Kura, including any decision made based on information shown in the app. Nothing in these Terms limits liability that cannot be limited by law.

## 11. Ending your use
You can stop using Kura and delete your account at any time (Settings → Email & password). We may suspend or terminate access if these Terms are breached or to comply with the law.
...
We may update these Terms as Kura evolves. We’ll change the “Last updated” date above and, for significant changes, give you notice in the app. Continuing to use Kura after a change means you accept the updated Terms.
...
## Getting started
### What is Kura?
Kura is a personal-finance app for tracking your income, expenses and transfers across all of your accounts and currencies — so you always know where your money is and where it’s going.

### Does Kura connect to my bank?
No. Kura never connects to your bank and never asks for your online-banking login. You add transactions yourself, or use the premium statement converter to turn a statement file you already have into ready-to-review rows.
...
### Can I install Kura like an app?
Yes — Kura is a progressive web app. In your phone browser, choose “Add to Home Screen” (or “Install app”). It then opens full-screen like a normal app.
...
Each account has its own currency. To combine everything into one figure, Kura converts foreign balances into your base currency using the exchange rates you set in Settings → Exchange rates. Set your base currency in Settings → Preferences.
...
Yes. If a PDF needs a password, you enter it on your device to open the file. For multi-currency statements, Kura focuses on the currency of the account you’re importing into.

### It didn’t read my bank’s format. What now?
If automatic reading finds nothing, Kura switches to a quick “teach” mode: you tap the date and amount on one row, and Kura learns your bank’s layout and remembers it on your device for next time. Scanned or image-only PDFs aren’t supported — use the CSV export from your bank instead.

## Premium
### What’s included in Premium?
Premium currently unlocks the bank-statement converter. Everything else in Kura is free.

### How do I get Premium?
Premium is invite-only right now and granted manually at no charge while Kura is in its early stage. Open the bank-statement feature and tap “Request access”, or email [${CONTACT}](mailto:${CONTACT}).
...
## Troubleshooting
### Kura still looks like the old version after an update.
If you’ve installed Kura to your home screen, fully close it and reopen it once after an update so it loads the newest version. A normal browser refresh also works.
